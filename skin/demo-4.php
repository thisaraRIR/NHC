...
<html lang="en">
	...
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  		...
  		<!-- SITE TITLE -->
		<title>Nature's Healing | Home Page</title>
				 	...
				 	<!-- NAVIGATION MENU -->
				  	<div class="wsmainfull menu clearfix">
	    				<div class="wsmainwp clearfix">
	    					...
	    					<div class="desktoplogo"><a href="#hero-4" class="logo-black"><img src="images/Logo/NH-web-logo-gold.png" width="170" height="50" alt="header-logo"></a></div>
	    					<div class="desktoplogo"><a href="#hero-4" class="logo-white"><img src="images/Logo/NH-web-logo-white.png" width="170" height="50" alt="header-logo"></a></div>
	      					...
	      					<nav class="wsmenu clearfix">
	        					<ul class="wsmenu-list">
	               								...
	               								<div class="row">
									                ...
									                <!-- MEGAMENU LINKS -->
	               									<ul class="col-md-12 col-lg-4 link-list">
									                    <li class="title txt-color-01"><p>Facial Treatments</p></li>
									                ...
									                <!-- MEGAMENU LINKS -->
	               									<ul class="col-md-12 col-lg-4 link-list">
									                    <li class="title txt-color-01"><p>Body Treatments</p></li>
													...
													<!-- MEGAMENU LINKS -->
													<ul class="col-md-12 col-lg-4 link-list">
									                    <li class="title txt-color-01"><p>Cosmatic Massages</p></li>
							    	...
							    	<li class="nl-simple header-phone" aria-haspopup="true">
							    		<a href="tel:123456789"><span class="bg-color-09 white-color"><i class="fas fa-phone"></i></span>+94 77 072 8767</a>
							    	</li> 
		       							...
		       							<div class="row">
		       								<div class="col-md-12">
					            				<div class="caption white-color">
								            		...
								            		<!-- Title -->
								              		<div class="title"><h2>Bodycare</h2></div>
		       							...
		       							<div class="row">
		       								<div class="col-md-12">			          		
					            				<div class="caption white-color">
								            		...
								            		<!-- Title -->
								              		<div class="title"><h2>Scincare</h2></div>
		       							...
		       							<div class="row">
		       								<div class="col-md-12">       
					            				<div class="caption text-center white-color">
								            		...
								            		<!-- Title -->
								              		<div class="title"><h2>Detoxification</h2></div>
							...
							<div class="col-md-6">
								<div id="s13-2" class="sbox-13 bg-fixed bg-color-02">
									<div class="sbox-13-txt">
										...
										<!-- Title -->
										<h5 class="h5-xl txt-color-01">Skin Care</h5>	
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-7 col-lg-6">
							<div class="txt-block">
								...
								<!-- Text -->	
								<p class="p-xl txt-color-01">Call us : <span>+94 77 072 8767</span> or fill out our online booking & equiry 
