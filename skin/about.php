			...
			<div class="header-wrapper">
				...
				<div class="wsmainfull menu clearfix">
					<div class="wsmainwp clearfix">
						...
						<div class="desktoplogo"><a href="#about-page" class="logo-black"><img src="images/Logo/NH-web-logo-gold.png"
									width="170" height="50" alt="header-logo"></a></div>
						<div class="desktoplogo"><a href="#about-page" class="logo-white"><img
									src="images/Logo/NH-web-logo-gold.png" width="170" height="50" alt="header-logo"></a></div>
