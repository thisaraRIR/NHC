...
<head>
	...
	<!-- SITE TITLE -->
	<title>Nature's Healing | Product Price List</title>
...
<body>
	...
	<div id="page" class="page">
		...
		<div class="inner-page-wrapper">
			...
			<!-- PAGE HERO
				============================================= -->
			<section id="pricing-page" class="bg-fixed wide-100 page-hero-section division">
				<div class="container">
					...
					<div class="row">
						<div class="col-md-10 col-xl-8 offset-md-1 offset-xl-2">
							<div class="hero-txt text-center white-color">
								...
								<!-- Title -->
								<h2 class="h2-lg">Pricing Plans</h2>
								...
								<div class="breadcrumb-nav">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item active" aria-current="page">Our Pricing Plans
											</li>
										</ol>
									</nav>
								</div>
					...
					<div class="row">
						<div class="col-lg-10 offset-lg-1">
							<div class="section-title mb-60 text-center">
								...
								<!-- Transparent Header -->
								<h2 class="tra-header txt-color-02"></h2>
							...
							<div class="footer-info mb-40">
								...
								<div class="footer-contacts txt-color-05 mt-25">
									...
									<p class="foo-email">E: <a
											href="natureshealing.ceylon@gmail.com">natureshealing.ceylon@gmail.com</a></p>
