...
<head>
	...
	<meta name="description" content="Nature's Healing" />
	<meta name="keywords"
		content="Jthemes, Beauty, Cosmetic, Girly, Health, Healthy Care, Massage, Make Up, Salon, Spa, Skincare, Wellness">
	<meta name="viewport" content="width=device-width, initial-scale=1.0" />

	<!-- SITE TITLE -->
	<title>Nature's Healing | Blog</title>

	<!-- FAVICON AND TOUCH ICONS -->
	<link rel="shortcut icon" href="images/Logo/NH-web-logo-gold.png" type="image/x-icon">
	<link rel="icon" href="images/Logo/NH-web-logo-gold.png" type="image/x-icon">
	<link rel="apple-touch-icon" sizes="152x152" href="images/Logo/NH-web-logo-gold.png">
	<link rel="apple-touch-icon" sizes="120x120" href="images/Logo/NH-web-logo-gold.png">
	<link rel="apple-touch-icon" sizes="76x76" href="images/Logo/NH-web-logo-gold.png">
	<link rel="apple-touch-icon" href="images/Logo/NH-web-logo-gold.png">
	<link rel="icon" href="images/Logo/NH-web-logo-gold.png" type="image/x-icon">
			...
			<div class="header-wrapper">
				...
				<div class="wsmainfull menu clearfix">
					<div class="wsmainwp clearfix">
						...
						<div class="desktoplogo"><a href="#blogs-page" class="logo-black"><img
									src="images/Logo/NH-web-logo-gold.png" width="170" height="50"
									alt="header-logo"></a></div>
						<div class="desktoplogo"><a href="#blogs-page" class="logo-white"><img
									src="images/Logo/NH-web-logo-gold.png" width="170" height="50"
									alt="header-logo"></a></div>
						...
						<nav class="wsmenu clearfix">
							<ul class="wsmenu-list">
								...
								<!-- MEGAMENU -->
								<li aria-haspopup="true"><a href="#">Tratments <span class="wsarrow"></span></a>
							...
							<div class="blog-post">
								...
								<div class="blog-post-txt">
									...
									<h5 class="h5-sm txt-color-01">
										<a href="single-post.html">Quaerat neque purus ipsum neque dolor primis
											libero</a>
									</h5>
						...
						<div class="col-md-6 col-lg-4">
							<div class="blog-post">
								...
								<div class="blog-post-txt">
									...
									<!-- Post Title -->
									<h5 class="h5-sm txt-color-01">
										<a href="single-post.html">Massa placerat bibendum and purus aliquet
											elementum</a>
									</h5>
						...
						<div class="col-md-6 col-lg-4">
							<div class="blog-post">
								...
								<div class="blog-post-txt">
									...
									<!-- Post Title -->
									<h5 class="h5-sm txt-color-01">
										<a href="single-post.html">Maecenas gravida at porttitor vehicula magna
											luctus</a>
									</h5>
						...
						<div class="col-md-4 col-lg-3 col-xl-3">
							<div class="footer-contacts mb-40">
								...
								<div class="txt-color-05 mt-15">
									...
									<!-- <p>Skype : <a href="tel:077 072 8767">support.spamagic</a></p> -->
